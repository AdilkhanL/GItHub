...
# Images
bg = pygame.image.load("Lab8/Car/Road.png").convert_alpha()
...
#Шрифт
label = pygame.font.Font("Lab8/Car/RobotoFlex[slnt,wdth,wght,opsz].ttf", 60)
...
#Бал саны
Score = 0
b = 0 #velocity of acceleration

#False болса жеңілу экранын шығаратын 
gameplay = True
...
while running:
    ...
    if gameplay:
        ...
        #Player-дің көрінбейтін төртбұрышы
